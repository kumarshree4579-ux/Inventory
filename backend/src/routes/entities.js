...
// Customers
router.use('/customers', makeRouter(Customer, 'pos', 'pos', 'branch'));
...
(() => {
  ...
  r.post('/', can('settings', 'create'), crud.create);
  r.put('/:id', can('settings', 'edit'), crud.update);
  r.delete('/:id', can('settings', 'delete'), crud.remove);
...
(() => {
  ...
  r.post('/', can('pos', 'create'), async (req, res, next) => {
    try {
  ...
  r.delete('/:id', can('pos', 'delete'), async (req, res, next) => {
    try {
